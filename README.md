...
@chinesenintendo - Controls information

@OhL00k1tsB3nny - Replicated Profile Config
...
3. Open the "Nvidia Shield TV Punch-Out Wii Controller Scheme Profile For Dolphin Emulator" folder in the ZIP file And select both "Config" folder (contains.ini file) and "Load" (contains Button textures).

4. Drag both folders to the "Dolphin Emulator" folder you just opened.

5. Go back to Dolphin and Select "Controllers".

6. Select "Configure" for "Wii Remote 1".
